...
describe('Authentication API', () => {
  ...
  describe('OTP Flow', () => {
    ...
    it('should return 200 when verifying valid OTP', async () => {
      (MockedAuthRepository.findRecentOtp as any).mockResolvedValue({ id: 'o1', codeHash: 'hashed' });
      (MockedArgon2.verify as any).mockResolvedValue(true);
  ...
  describe('Classic Login', () => {
    it('should return 401 for invalid credentials', async () => {
      ...
      (MockedArgon2.verify as any).mockResolvedValue(false);
